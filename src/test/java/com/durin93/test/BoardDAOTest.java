...
import com.durin93.persistence.BoardDAO;
...
public class BoardDAOTest {
	 ...
	 * board.setContent("수정된 글 입니다."); dao.update(board);
	 * 
	 * }
	 * 
	 ...
	 */
	/*
	 * @Test public void testListCriteria()throws Exception{
	 * 
	 * Criteria cri = new Criteria(); cri.setPage(2); cri.setPerPageNum(20);
	 * 
	...
	/*
	 * @Test public void testURI() throws Exception{ UriComponents uriComponents =
	 * UriComponentsBuilder.newInstance().path("/board/read").queryParam("bno",
	 * 12).queryParam("perPageNum", 20).build();
	 * 
